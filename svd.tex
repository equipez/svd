...
\begin{definition}
  ...
  \begin{enumerate}[leftmargin=1.5em]
    \item 
      $U\Lambda U^\hmt$ is called an eigenvalue decomposition of~$A$, if~$A = U \Lambda U^\hmt$, $U
    ...
    \item 
      ...
      if~$A = U \Lambda U^\hmt$, $U \in \CC^{n\times r}$ is a matrix with~$U^\hmt U = I_r$,
...
\begin{definition}
  ...
  \begin{enumerate}[leftmargin=1.5em]
    ...
    \item 
      When~$r \ge 1$, $U\Sigma U^\hmt$ is called a compact (or \emph{reduced}) singular value decomposition of~$A$,
...
\begin{remark}
  ...
  \begin{enumerate}[leftmargin=1.5em]
    ...
    which are nonzero since~$w\neq 0$. Finally, let~$u = x/\|x\|$ and~$y = y/\|y\|$. 
  \end{enumerate}
\end{remark}
